...
function AddPdf({ onHandleAddNote }) {
    ...
    const a = false;
    return (
        <div v className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-gray-600 bg-opacity-60 backdrop-filter backdrop-blur-lg">
                        ...
                        <div className=" p-5 flex flex-col gap-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    type="file"
                                    className="border border-gray-300 rounded-md px-2 py-1  focus:outline-none placeholder:text-sm placeholder:text-gray-400"
                                    placeholder="Upload a img for Pdf sThumbnail"
                                    required
                                />
                            </div>
                            <div className="flex flex-col">
